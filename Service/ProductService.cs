...
namespace Service
{
    public class ProductService : IProductContract
    {
        ...
        {
            var getAllRoboticsAgents = await _repositoryManager.productRepository.getAllRoboticsAgents(ProductId);
            return getAllRoboticsAgents;
        }
        public async Task<ResponseViewModel> getAllAIAgents(Guid? ProductId)
        {
            var getAllAIAgents = await _repositoryManager.productRepository.getAllAIAgents(ProductId);
            return getAllAIAgents;
        }
        public async Task<ResponseViewModel> getAllProjectAgents(Guid? ProductId)
        {
            var getAllProjectAgents = await _repositoryManager.productRepository.getAllProjectAgents(ProductId);
