...
namespace Repository
{
    public class WalletReportRepository : IWalletReportRepository
    {
        ...
        public async Task<ResponseViewModel> getIncomeAndDepositTransType(Guid URID)
        {
            ...
            var rentProc = Constant.getRentWalletTransType;
            ...
            using (var connection = _dapperContext.createConnection())
            {
                try
                {
                    ...
                    var rentProcResult = await connection.QueryAsync(rentProc, parameters, commandType: CommandType.StoredProcedure);
                    var rentlist = rentProcResult.ToList();

                    if ((incomeList != null && incomeList.Any()) || (depositList != null && depositList.Any()) || (rentlist != null && rentlist.Any()))
                    {
        ...
        {
            var procedureName = Constant.incomeWithdrawalHistory;
            var parameters = new DynamicParameters();
        ...
        {
            var procedureName = Constant.getRentWalletStatement;
            var parameters = new DynamicParameters();
