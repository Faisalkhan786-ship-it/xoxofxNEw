...
namespace Repository
{
    public class AdminManageFundRepository: IAdminManageFundRepository
    {
        ...
        public async Task<ResponseViewModel> getAllUserWithdrawalRequest_Admin(UnAppIncomeViewModel appUnAppFundRequestModel)
        {
        ...
        public async Task<ResponseViewModel> getAllUserROIWithdrawalRequest_Admin(UnAppIncomeViewModel appUnAppFundRequestModel)
        {
